  ...
  return (
    ...
    >
      ...
      <div className="w-full h-fit py-4 flex flex-col gap-4 items-start z-10">
        ...
        <div className="bg-white w-full md:w-[45%] h-fit py-4 px-2 flex flex-col items-center rounded-md md:mt-4 md:px-6">
          <h3 className="text-xl md:text-2xl text-black">Track my Shipment</h3>

          <div className="flex flex-col items-center w-full md:gap-8 md:flex-row mt-4 px-4 justify-center">
            <input
              type="text"
              placeholder="Booking No. Containers No"
              className="bg-blue-100 w-full rounded-[2rem] md:w-[50%] px-4 py-2 mb-4 text-gray-600"
            />
